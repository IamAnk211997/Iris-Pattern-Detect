...
%[ gabor_reout2, gabor_imout ]=gabor_fn(sigma, theta, lambda, psi, gamma,image_double);

%figure; imshow(gabor_reout2);title('theta pi/2');
...
%theta =pi;
%[ gabor_reout4, gabor_imout ]=gabor_fn(sigma, theta, lambda, psi, gamma,image_double);

%figure; imshow(gabor_reout4);title('theta pi');

% 
% gabor_reout = max(gabor_reout1,gabor_reout3);
% 
% % gabor_reout = max(gabor_reout2,gabor_reout4);
% 
% figure; imshow(gabor_reout);title('max of all r_gb');
